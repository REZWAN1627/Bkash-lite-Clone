 ...
 * Use the {@link ChangeName#newInstance} factory method to
...
public class ChangeName extends Fragment {
    ...
    public static ChangeName newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view.findViewById(R.id.next_from_settings).setOnClickListener(new View.OnClickListener() {
            @Override
